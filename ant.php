<html> 
   <head> 
      ...
      <script type="text/javascript" language="javascript"> 
    	...
    	$(".mytable", clone).html('<table><tr><td><table border="1" class="c2cgain"><thead>C2CGain:<span data-tag="'+check(gain)+'" >'+gain+'</span><span data-tag="'+check(per)+'" >&nbsp;&nbsp;'+per+'%</span><span> U:'+m+' D:'+parseFloat(57-m)+' P'+parseFloat((m/57)*100).toFixed(2)+'</span></thead><th>Cname</th><th>Gain</th><th>Gain%</th><th>close</th></table></td><td><table border="1" class="c2ogain"><thead>C2OGain:<span data-tag="'+check(gain1)+'" >'+gain1+'</span><span data-tag="'+check(per1)+'" >&nbsp;&nbsp;'+per1+'%</span><span>U:'+n+' D:'+parseFloat(57-n)+' P'+parseFloat((n/57)*100).toFixed(2)+'</span></thead><th>Cname</th><th>Gain</th><th>Gain%</th><th>close</th></table></td><td><table border="1" class="o2ogain"><thead>O2OGain:<span data-tag="'+check(gain2)+'" >'+gain2+'</span><span data-tag="'+check(per2)+'" >&nbsp;&nbsp;'+per2+'%</span><span>U:'+o+' D:'+parseFloat(57-o)+' P'+parseFloat((o/57)*100).toFixed(2)+'</span></thead><th>Cname</th><th>Gain</th><th>Gain%</th><th>close</th></table></td><td><table border="1" class="o2cgain"><thead>O2CGain:<span data-tag="'+check(gain3)+'" >'+gain3+'</span><span data-tag="'+check(per3)+'" >&nbsp;&nbsp;'+per3+'%</span><span>U:'+p+' D:'+parseFloat(57-p)+' P'+parseFloat((p/57)*100).toFixed(2)+'</span></thead><th>Cname</th><th>Gain</th><th>Gain%</th><th>close</th></table></td></tr></table>')
